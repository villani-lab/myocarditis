...
```{r message=FALSE, results = 'hold', warning = F, fig.width = 15, fig.height = 10, fig_1a}
# read in data
...
```{r message = FALSE, warning = FALSE, results = 'hold', fig.width = 15, fig.height = 10, fig_1e}
# read in tissue data
...
```{r message = F, results = F, warning = F, fig_1f_run_de_analysis}
...
```{r message = F, results = F, warning = F, fig_1f_run_gsea}
...
## Figure 1i
```{r message = F, warning = F, results = 'hold', fig.width = 14, fig.height = 7, fig_1j}
...
```{python results = 'hold', fig_1j_python}
...
```{r message = F, results = 'hold', fig.width = 7, fig.height = 7, fig_1j_r}
...
```{r fig_1k,message = F, results = 'hold', fig.width = 7, fig.height = 7}
