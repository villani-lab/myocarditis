...
```{python message = F, results = 'hold', fig_1i}
...
```{python results = 'hide', make_blood_pb}
...
```{r message = F, results = 'hold', fig_1k}
setwd('/projects/home/sramesh/github/myocarditis')
...
case_control_lineage_results <- run_de_by_comp_var(counts, meta, 'output/blood', case_control_contrast_vec,
