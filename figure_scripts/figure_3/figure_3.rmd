...
```{r message = F, results = 'hold', warning = F, fig_3d}
...
```{r message = F, warning = F, results = F, fig_3e_run_de_analysis}
...
```{r message = F, results = 'hold', fig.width = 10, fig.height = 12, fig_3e_de_heatmap}
tissue_obs <- read_csv('/projects/home/ikernin/projects/myocarditis/updated_datasets/metadata/tissue_full_obs.csv')
...
```{r message = F, warning = F, results = F, fig_3e_run_gsea}
# filter out doublets
...
```{r fig.width = 10, fig.height = 10, fig_3e_plot_gsea}
...
```{r fig_3h, fig.width = 10, fig.height = 10, message = F, warning = F, results = 'hold'}
