...
```{r message = F, warning = F, results = 'hold',  fig.width = 15, fig.height = 10, fig_3c}
...
```{r message = F, results = 'hold', fig_3e_de_analysis}
# run DE analysis by condition
t_deres <- run_de_by_comp_var(counts_filepath = '/projects/home/ikernin/projects/myocarditis/github_datasets/tissue_t_pseudocounts.csv',
                               meta_filepath = '/projects/home/ikernin/projects/myocarditis/github_datasets/tissue_t_metainfo.csv',
                               save_name = 'tissue_t',
                               comp_var_contrast_vec = 'condition')

t_grouped_deres <- run_de_by_comp_var(counts_filepath = '/projects/home/ikernin/projects/myocarditis/github_datasets/tissue_t_grouped_pseudocounts.csv',
...
```{r message = F, results = 'hold', fig.width = 10, fig.height = 12, fig_3e_heatmap}
...
```{r fig_3h, fig.width = 10, fig.height = 10}
