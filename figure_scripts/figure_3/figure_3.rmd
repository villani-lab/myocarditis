...
## Figure 3C
```{r fig_3C, message=FALSE, warning=FALSE}
...
## Figure 3D
```{r fig_3d, fig.width = 6, fig.height = 6}
...
```{r fig_3e, fig.height = 10, fig.width = 14}
...
```{r fig_3h, fig.height = 10, fig.width = 8}
