...
```{r message = F, warning = F, results = 'hold',  fig.width = 15, fig.height = 10, fig_6c}
# filter
...
```{r message = F, results = F, fig_6d_run_de_analysis}
...
```{r message = F, results = F, warning = F, eval = F, fig_5f_run_gsea}
# filter out doublets
...
```{r warning = F, message = F, results = 'hold', fig_6h}
