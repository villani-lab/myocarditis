...
```{r fig_S5B, message = FALSE, warning = FALSE}
...
```{r fig_S5c, fig.height = 20, fig.width = 20}
...
```{r fig_s5f, fig.width = 20, fig.height = 20}
...
```{r supp_6e, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 8}
...
```{r fig_s6h, fig.width = 15, fig.height = 10}
