...
```{r results = 'hold', message = F, supp_1e}
...
```{r message = F, warning = F, results = 'hold', fig.width = 14, fig.height = 7, supp_1h}
...
```{r message = F, results = 'hold', warning = F, fig.width = 7, fig.height = 7, supp_1i}
#### first run de
...
```{python results = 'hold', message = F, supp_1j}
...
```{r message = F, results = 'hold', warning = F, fig.width = 14, fig.height = 7, supp_1L}
