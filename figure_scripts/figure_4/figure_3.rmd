...
## Figure 3B
```{r fig_3B, warning = FALSE, message = FALSE}
...
## Figure 3C
```{r fig_3c, warning=FALSE, message=FALSE}
...
##Figure 3D
```{r fig_3D, message=FALSE, warning=FALSE}
...
## Figure 3G
```{r fig_3g, fig.width = 6, fig.height = 6}
...
```{r fig_3h, warning=FALSE, message=FALSE, fig.width = 13, fig.height = 10}
