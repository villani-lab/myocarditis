...
```{r message = F, results = F, fig_4j_run_de_analysis}
...
```{r message = F, results = 'hold', fig.width = 10, fig.height = 16, fig_4j_heatmap}
...
```{r message = F, results = F, warning = F, fig_4j_run_gsea}
# filter out doublets
...
```{r fig.width = 5, fig.height = 5, fig_4j_plot_gsea}
