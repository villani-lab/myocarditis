...
## Figure 4B
```{r fig_4B, warning = FALSE, message = FALSE}
...
## Figure 4C
```{r fig_4c, warning=FALSE, message=FALSE}
...
##Figure 4D
```{r fig_4D, message=FALSE, warning=FALSE}
...
## Figure 4E
```{r fig_4e, fig.width = 6, fig.height = 6}
...
```{r fig_4f, fig.height = 10, fig.width = 14}
...
```{r fig_4i, fig.height = 10, fig.width = 8}
