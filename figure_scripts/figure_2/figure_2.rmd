...
```{r message = F, warning = F, results = F, fig_2d_run_de_analysis}
...
```{r fig_2f, fig.width = 10, fig.height = 10, message = F, warning = F, results = 'hold'}
